...
###Calculate average of studied
def calculate_average_hours_studied(dataset):
    # Calculate average hours studied
    average_hours_studied = dataset['Hours Studied'].mean()
    print(f"Average Hours Studied: {average_hours_studied:.2f} hours")
